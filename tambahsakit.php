...
<div class="inner-block">
    <div class="blank">
    	<div class="blankpage-main">
    		...
    		<form id="formData" method="POST" action="simpansakit.php">
                <div class="form-group">
                  <input readonly value="<?php echo $dataUser["ID_STAF"]; ?>" type="text" class="form-control" id="id_staf" name="id_staf">
                </div>
                <div class="form-group">
                  <label for="email">Tanggal mulai sakit:</label>
                  <input type="date" class="form-control" id="tgl_mulai_sakit" name="tgl_mulai_sakit">
                </div>
                <div class="form-group">
                  <label for="email">Tanggal selesai sakit:</label>
                  <input type="date" class="form-control" id="tgl_selesai_sakit" name="tgl_selesai_sakit">
                </div>
                <div class="form-group">
                  <label for="email">Alasan sakit:</label>
                  <input type="text" class="form-control" id="alasan_sakit" name="alasan_sakit">
                </div>
                <div class="form-group">
...
?>
  <script>
        ...
        function hitunghari()
        {
              var tanggal=new Date($("#tgl_mulai_sakit").val());
              var tanggal2=new Date($("#tgl_selesai_sakit").val());
              var timeDiff = Math.abs(1 + tanggal2.getTime() - tanggal.getTime());
        ...
        $(document).ready(function()
        {
            ...
            $("#tgl_selesai_sakit").change(function()
              {
                hitunghari();
              });
        });
