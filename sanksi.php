...
<div class="inner-block">
    <div class="blank">
    	<div class="blankpage-main">
    		<h2>Sanksi</h2>
    		<a class="btn btn-warning btn_tmbahuser" href="tambahsanksi.php">Masukan sanksi</a><br><br>
    		<div class="table-responsive">
                ...
                <tr>
                  ...
                  <th scope="col">Keterangan sanksi</th>
              ...
              <tbody>
                 <?php
                    $no=1;
                    $q="SELECT * FROM sanksi t INNER JOIN staf s ON (s.ID_STAF=t.ID_STAF)";
