...
<div class="inner-block">
    <div class="blank">
        ...
        <?php
          $id=$_GET["id"];
          $q="SELECT * FROM jabatan WHERE ID_JABATAN='$id'";
          $res=mysqli_query($con,$q);
          $dataJab=mysqli_fetch_array($res);
        ?>
    		<form id="formData" method="POST" action="simpanupdatejabatan.php">
                <input type="hidden" name="id" value="<?php echo $_GET["id"];?>"/>
                <div class="form-group">
                  <label for="email">Jabatan:</label>
                  <input value="<?php echo $dataJab["NAMA_JABATAN"]; ?>" type="text" class="form-control" id="nama_jabatan" name="nama_jabatan">
                </div>
