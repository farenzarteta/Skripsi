...
<div class="inner-block">
    <div class="blank">
    	<div class="blankpage-main">
    		...
    		<form id="formData" method="POST" action="simpanlibur.php">
                <div class="form-group">
                  <label for="email">Tanggal hari libur:</label>
                  <input type="date" class="form-control" id="tgl_libur" name="tgl_libur">
                </div>
                <div class="form-group">
                  <label for="email">Keterangan hari libur:</label>
                  <input type="text" class="form-control" id="keterangan" name="keterangan">
                </div>
                <button type="button" id="buttonSimpan" class="btn btn-default">Simpan</button>
        </form>
    	</div>
    </div>
</div>
