        ...
        <div class="table-responsive">
              ...
              <tbody>
                 <?php
                    $no=1;
                    $id=$_SESSION["id"];
                    $q="SELECT u.ID_STAF,ps.TGL_LEMBUR,ps.JAM_MULAI_LEMBUR, ps.JAM_SELESAI_LEMBUR, ps.DURASI_LEMBUR, ps.STATUS FROM staf u INNER JOIN user_staf s ON  (s.id_staf=u.id_staf) INNER JOIN pengajuan_lembur ps ON  (ps.id_staf=u.id_staf) WHERE s.id_user='$id'";
                    //echo $q;
