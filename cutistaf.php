        ...
        <div class="table-responsive">
              ...
              <tbody>
                 <?php
                    $no=1;
                    $id=$_SESSION["id"];
                    $q="SELECT u.ID_STAF,ps._TGL_MULAI_CUTI,ps.TGL_SELESAI_CUTI, ps.ALASAN_CUTI, ps.JUMLAH, ps.STATUS, ps.ID_CUTI ".
                    "FROM staf u ".
                    "INNER JOIN user_staf s ON  (s.id_staf=u.id_staf) ".
                    "INNER JOIN pengajuan_cuti ps ON  (ps.id_staf=u.id_staf) WHERE s.id_user='$id'";
                    //echo $q;
