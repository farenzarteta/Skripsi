...
<div class="inner-block">
    <div class="blank">
        ...
        <?php
          $id=$_GET["id"];
          $q="SELECT * FROM pertanyaan WHERE ID_PERTANYAAN='$id'";
          $res=mysqli_query($con,$q);
          $dataJab=mysqli_fetch_array($res);
        ?>
    		<form id="formData" method="POST" action="simpanupdatepertanyaan.php">
                <input type="hidden" name="id" value="<?php echo $_GET["id"];?>"/>
                <div class="form-group">
                  <label for="email">Pertanyaan:</label>
                  <input value="<?php echo $dataJab["PERTANYAAN"]; ?>" type="text" class="form-control" id="pertanyaan" name="pertanyaan">
                </div>
