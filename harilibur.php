...
<div class="inner-block">
    <div class="blank">
    	<div class="blankpage-main">
    		<h2>Hari libur</h2>
    		<a class="btn btn-warning btn_tmbahuser" href="tambahlibur.php">Masukan Hhari libur</a><br><br>
    		<div class="table-responsive">
                <table class="table table-hover">
                      <thead>
                <tr>
                  <th scope="col">No.</th>
                  <th scope="col">Tanggal hari libur</th>
                  <th scope="col">Keterangan hari libur</th>
                    ...
                    while ($row=mysqli_fetch_assoc($res))
                    {
                      ?>
                        <tr>
                            ...
                            <td>
                              <?php
                                echo $row["TGL_HARILIBUR"];
                              ?>
                            </td>
                            <td>
                              <?php
                              	echo $row["KET_HARILLIBUR"];
                              ?>
                            </td>
                            <td>
