                      ...
                      <table class="table table-bordered">
                                ...
                                <tbody>
                                   <?php
                                      ...
                                      $q7="SELECT pp.* ".
                                         "FROM user_staf u7 ".
                                         "INNER JOIN staf s7 ON  (s7.id_staf=u7.id_staf) ".
                                         "INNER JOIN prestasi pp ON (pp.id_staf=s7.id_staf)  ".
                                         "WHERE u7.id_user='$id7'";
                                        //echo $q7;
                                      $res7=mysqli_query($con,$q7);
                                      while ($dataUser7=mysqli_fetch_assoc($res7))
                                      {
                                        ?>
                                          <tr>
                                              <td>
